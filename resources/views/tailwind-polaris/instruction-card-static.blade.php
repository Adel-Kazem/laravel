<div
        id="dropdown-element"
        class="lg:w-5/6 bg-white border mx-auto my-10 border-gray-200 rounded-xl p-4 border-b-gray-200 border-b-2 shadow-sm complex-learn-card-dropdown"
>
    <div class="flex justify-between">
        ...
        <div class="flex justify-between items-center relative">
            ...
            <div id="main-toogler-dots" class="hidden relative">
                <div
                        id="dropdown-menu"
                        class="absolute right-0 top-0 z-10 mt-4 w-30 origin-top-right rounded-xl bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
                        role="menu"
                ...
                >
                    <div class="px-1.5 py-1.5 rounded" role="none">
                        <a
                                href="#"
                                class="text-gray-700 block px-2 py-1.5 rounded-md hover:bg-gray-100 text-sm"
                                role="menuitem"
                                tabindex="-1"
                                id="menu-item-0"
                        >Dismiss</a
    ...
    <p class="text-sm text-inherit">
        Increase the percentage of the vistors who purchase something from your online store.
    </p>
    <p
            id="completed-text"
            class=" text text-inherit border border-gray-300 rounded-md mt-2 text-center "
    >
        0/3 completed
    </p>
    <br>
    ...
    <!-- first text -->
    <div id="sec1" class="clcd-check rounded-lg my-3 p-2 mb-2">
        <div class="flex">
            <div>
                <img id="check1dot" src="{{ asset('images/icons/circle-dash.svg') }}" width="24" height="24" alt="Circle Dash">

                <svg id="check1tic" class="checkdisplay" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-check-circle-fill" viewBox="0 0 16 16">
                    <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0m-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"/>
                </svg>
            </div>
            &ensp;
            <div class="text-sm mb-2 text-inherit">Give a buy X, get Y discount</div>
        </div>
        <div class="flex">
            <div style="width: 70%;">
                <p class="text-sm mb-2 text-inherit font ml-8">
                    70% of conversation in shopify Inbox are with costumer making a purchase descision. Chat with
                    shoppers to help them complete their purchases. <a href="" class="text-blue-500 font-medium">Learn
                        more</a>
                </p>
                <button
                        id="check2"
                        class="primary-button buttonPressable primaryButtonShadow text-white px-2 py-1.5 text-xs rounded-md font-semibold ml-8"
                        onclick="incrementcheck(1)"
                >
    ...
    <!-- 2nd text -->
    <div id="sec2" class="clcd-check rounded-lg my-3 p-2 mb-2">
        <div class="flex">
            <div>
                <img id="check2dot" src="{{ asset('images/icons/circle-dash.svg') }}" width="24" height="24" alt="Circle Dash">

                <svg id="check2tic" class="checkdisplay" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-check-circle-fill" viewBox="0 0 16 16">
                    <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0m-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"/>
                </svg>
            </div>
            &ensp;
            <div class="text-sm mb-2 text-inherit">Answer questions with Shopify Inbox</div>
        </div>
        <div class="flex">
            <div style="width: 70%;">
                <p class="text-sm mb-2 text-inherit font ml-8">
    ...
    <!-- 3rd text  -->
    <div id="sec3" class="clcd-check rounded-lg my-3 p-2 mb-2">
        <div class="flex">
            <div>
                <img id="check3dot" src="{{ asset('images/icons/circle-dash.svg') }}" width="24" height="24" alt="Circle Dash">

                <svg id="check3tic" class="checkdisplay" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-check-circle-fill" viewBox="0 0 16 16">
                    <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0m-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"/>
                </svg>
            </div>
            &ensp;
            <div class="text-sm mb-2 text-inherit">Gain trust with reviews</div>
        </div>
        <div class="flex">
            <div style="width: 70%;">
                <p class="text-sm mb-2 text-inherit font ml-8">
